...
Defined in: [hooks/useBibleBookName.ts:19](https://github.com/genesis-ai-dev/langquest/blob/7b5bd2a536b6b422f664dee469db2b301d95de39/hooks/useBibleBookName.ts#L19)
