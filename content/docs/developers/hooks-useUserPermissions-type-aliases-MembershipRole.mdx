...
Defined in: [hooks/useUserPermissions.ts:42](https://github.com/genesis-ai-dev/langquest/blob/7b5bd2a536b6b422f664dee469db2b301d95de39/hooks/useUserPermissions.ts#L42)
