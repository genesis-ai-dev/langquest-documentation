...
Defined in: [hooks/db/useLanguages.ts:49](https://github.com/genesis-ai-dev/langquest/blob/bcf9613481583b05699aeca2003ff5ce69686880/hooks/db/useLanguages.ts#L49)
