...
Defined in: [hooks/useHybridQuery.ts:66](https://github.com/genesis-ai-dev/langquest/blob/7b5bd2a536b6b422f664dee469db2b301d95de39/hooks/useHybridQuery.ts#L66)
