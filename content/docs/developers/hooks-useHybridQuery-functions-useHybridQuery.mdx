...
Defined in: [hooks/useHybridQuery.ts:66](https://github.com/genesis-ai-dev/langquest/blob/90e7b9591ac4f1dcbeb3e8a1c23701ba1ae31147/hooks/useHybridQuery.ts#L66)
