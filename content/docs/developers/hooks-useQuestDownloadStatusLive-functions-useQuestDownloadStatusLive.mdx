...
Defined in: [hooks/useQuestDownloadStatusLive.ts:15](https://github.com/genesis-ai-dev/langquest/blob/5c72cce893f9afcd54c2122f1e68d6ed37337b19/hooks/useQuestDownloadStatusLive.ts#L15)
