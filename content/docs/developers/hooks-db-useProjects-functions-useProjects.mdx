...
Defined in: [hooks/db/useProjects.ts:21](https://github.com/genesis-ai-dev/langquest/blob/5c72cce893f9afcd54c2122f1e68d6ed37337b19/hooks/db/useProjects.ts#L21)
