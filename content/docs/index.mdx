...
LangQuest is already being used to translate the Bible with a built-in FIA (Feel, Internalize, Articulate) guided workflow, but it handles more: traditional stories, oral histories, and educational materials.
